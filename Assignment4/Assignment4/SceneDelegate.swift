...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let cities = [
            createTabBarItem(city: vancouver),
            createTabBarItem(city: verona),
            createTabBarItem(city: tokyo),
            createTabBarItem(city: saoPaulo),
            createTabBarItem(city: seoul)
        ]
    ...
    func createTabBarItem(city: City ) -> CityViewController {
